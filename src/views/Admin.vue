                  ...
                  <div class="flex min-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0">
                    <div class="relative transform overflow-hidden bg-white text-left shadow-xl transition-all w-screen h-screen">
                      <div class=" px-4 pb-4 pt-5 bg-[#c2b669] sm:p-6 sm:pb-4 flex flex-row-reverse ">
                        <div class="py-3 px-12 w-[7%] cursor-pointer rounded-md hover:scale-105 ease-in-out duration-300 font-semibold bg-red text-white shadow-sm flex justify-evenly items-center" @click="function closecard() {open = false}">
                        close
                        </div>
                      </div>
                    </div>
